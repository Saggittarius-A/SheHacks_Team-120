          ...
          child: ListView(
            ...
            children: <Widget>[
              Column(
                ...
                children: <Widget>[
                  Text(" Freedo ", style: TextStyle(fontFamily: 'Amatic SC', color: Colors.white, fontSize: 40.0, fontWeight: FontWeight.bold)),
                  Text("Create or Join Groups", style: TextStyle(fontFamily: 'Amatic SC', color: Colors.white, fontSize: 20.0, fontWeight: FontWeight.bold)),
                  SizedBox(height: 30.0),
                
                  Text("Sign In", style: TextStyle( fontFamily: 'Amatic SC', color: Colors.white, fontSize: 25.0)),
